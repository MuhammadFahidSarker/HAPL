...
public interface HAPLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatStatement(HAPLParser.RepeatStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatWhile}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatWhile(HAPLParser.RepeatWhileContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatWithVar}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatWithVar(HAPLParser.RepeatWithVarContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatFrom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatFrom(HAPLParser.RepeatFromContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatTo}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatTo(HAPLParser.RepeatToContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatStep}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatStep(HAPLParser.RepeatStepContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#repeatFixed}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeatFixed(HAPLParser.RepeatFixedContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link HAPLParser#ifStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfStatement(HAPLParser.IfStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#ifStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfStat(HAPLParser.IfStatContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#elseIfStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseIfStat(HAPLParser.ElseIfStatContext ctx);
	/**
	 * Visit a parse tree produced by {@link HAPLParser#elseStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseStat(HAPLParser.ElseStatContext ctx);
	/**
