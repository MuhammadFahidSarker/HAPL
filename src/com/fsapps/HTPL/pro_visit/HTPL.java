...
public class HTPL implements Comparable<HTPL> {

    public static final HTPL NULL = new HTPL();
    public static final HTPL VOID = new HTPL();
    ...
    public List<HTPL> asList() {
        return (List<HTPL>)value;
    }
    ...
    @Override
    public int compareTo(HTPL that) {
